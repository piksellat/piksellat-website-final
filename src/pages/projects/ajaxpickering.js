...
import imgC1 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-01.jpg";
import imgC2 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-02.jpg";
import imgC3 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-03.jpg";
import imgC4 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-04.jpg";
import imgC5 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-05.jpg";
import imgC6 from "../../assets/image/portofoliopiece/ajaxpickering/Ajax-06.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">Ajax Pickering</h2>
                </div>
              </Col>
            </Row>
          </Container>
