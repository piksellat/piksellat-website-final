...
import imgC1 from "../../assets/image/portofoliopiece/airwego/AirWeGo-uai-1440x1080.jpg";
import imgC2 from "../../assets/image/portofoliopiece/airwego/86348439_202983767769570_2492674060819890176_n.jpg";
import imgC3 from "../../assets/image/portofoliopiece/airwego/AirWeGoWeb-uai-1440x1007.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">AirWeGo</h2>
                </div>
              </Col>
            </Row>
          </Container>
            ...
            <Row  className="justify-content-between">
              ...
              <div className="pr-xl-13">
                ...
                <div className="pr-xl-13">
                  ...
                  The whole idea for the logo and website design, was to put an emphasis on friendliness and ease-of-use. We hit the mark with the friendly logo and easy to use website experience. Air We Go is not your typical AC services providing company because they think of you like family, and they treat you like family.
                  </h2>
                </div>
              </Col>
