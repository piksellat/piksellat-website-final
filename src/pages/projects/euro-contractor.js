...
import imgC1 from "../../assets/image/portofoliopiece/eurocontractor/EuroContractor-base-uai-1440x1080.jpg";
import imgC2 from "../../assets/image/portofoliopiece/eurocontractor/EuroContractor-uai-1440x1080.jpg";
import imgC3 from "../../assets/image/portofoliopiece/eurocontractor/EuroContractor2-scaled-uai-1440x960.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">Euro Contractor</h2>
                </div>
              </Col>
            </Row>
          </Container>
            ...
            <Row  className="justify-content-between">
              ...
              <div className="pr-xl-13">
                ...
                <div className="pr-xl-13">
                  ...
                  Euro Contractors is a business supplies and equipment company based out of 11325 Sunset Ave, Banning, California, United States.

The aim of the logo is to create a recognizable brand that is memorable and conveys trust and connectability.
                  </h2>
                </div>
              </Col>
