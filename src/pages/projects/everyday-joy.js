...
import imgC1 from "../../assets/image/portofoliopiece/everydayjoy/EverydayJoy1-scaled-uai-1440x1066.jpg";
import imgC2 from "../../assets/image/portofoliopiece/everydayjoy/EverydayJoy2-scaled-uai-1440x961.jpg";
import imgC3 from "../../assets/image/portofoliopiece/everydayjoy/EverydayJoy3-scaled-uai-1440x1080.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">Everyday Joy</h2>
                </div>
              </Col>
            </Row>
          </Container>
            ...
            <Row  className="justify-content-between">
              ...
              <div className="pr-xl-13">
                ...
                <div className="pr-xl-13">
                  ...
                  Here’s something to motivate you to enjoy every single day.
                  </h2>
                </div>
              </Col>
