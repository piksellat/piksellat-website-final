...
import imgC1 from "../../assets/image/portofoliopiece/themergeI/01.jpg";
import imgC2 from "../../assets/image/portofoliopiece/themergeI/02.jpg";
import imgC3 from "../../assets/image/portofoliopiece/themergeI/03.jpg";
import imgC4 from "../../assets/image/portofoliopiece/themergeI/04.jpg";
import imgC5 from "../../assets/image/portofoliopiece/themergeI/05.jpg";
import imgC6 from "../../assets/image/portofoliopiece/themergeI/06.jpg";
import imgC7 from "../../assets/image/portofoliopiece/themergeI/07.jpg";
import imgC8 from "../../assets/image/portofoliopiece/themergeI/08.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">The Merge I</h2>
                </div>
              </Col>
            </Row>
          </Container>
