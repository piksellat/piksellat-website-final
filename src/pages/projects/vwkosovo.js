...
import imgC1 from "../../assets/image/portofoliopiece/vwkosovo/vw2.jpg";
import imgC2 from "../../assets/image/portofoliopiece/vwkosovo/vw.jpg";
import imgC3 from "../../assets/image/portofoliopiece/vwkosovo/vw3.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">VolksWagen Kosova Website</h2>
                </div>
              </Col>
            </Row>
          </Container>
