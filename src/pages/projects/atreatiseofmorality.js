...
import imgC1 from "../../assets/image/portofoliopiece/atreatiseofmorality/01.jpg";
import imgC2 from "../../assets/image/portofoliopiece/atreatiseofmorality/02.jpg";
import imgC3 from "../../assets/image/portofoliopiece/atreatiseofmorality/03.jpg";
import imgC4 from "../../assets/image/portofoliopiece/atreatiseofmorality/04.jpg";
import imgC5 from "../../assets/image/portofoliopiece/atreatiseofmorality/05.jpg";
import imgC6 from "../../assets/image/portofoliopiece/atreatiseofmorality/06.jpg";
import imgC7 from "../../assets/image/portofoliopiece/atreatiseofmorality/07.jpg";
import imgC8 from "../../assets/image/portofoliopiece/atreatiseofmorality/08.jpg";
            ...
            <Row className="justify-content-center mt-md-6 pt-24 pt-lg-29 no-padding">
              <Col lg="9" xl="8">
                <div className="px-md-12 text-center mb-11 mb-lg-14">
                  <h2 className="title gr-text-2 mb-9 mb-lg-12">A Treatise Of Morality</h2>
                </div>
              </Col>
            </Row>
          </Container>
